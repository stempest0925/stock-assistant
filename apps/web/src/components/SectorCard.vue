...
<template>
  ...
  >
    <i class="px-6 text-2xl font-black text-shadow-lg">01</i>
    <div class="flex-1 flex flex-col px-6 py-2 space-y-2 border-l border-gray-400">
      <div class="flex flex-row space-x-4 items-baseline">
        ...
        <h3 class="text-2xl font-bold tracking-wider text-shadow-lg">汽车零部件</h3>
        <span class="bg-[#f7f9fc] px-2 rounded">912044</span>
      </div>
      <div class="flex flex-row items-center space-x-4">
        <span class="px-4 py-0.5 bg-[#f7f9fc] rounded-xl">申万二级</span>
        <div class="flex flex-row bg-[#f7f9fc] rounded-xl px-4 py-0.5 items-center">
          <div class="w-8 aspect-square">
            <BaseIcon name="cn" />
          </div>
          <span>行业排名：第 1 名</span>
        </div>
      </div>
    </div>
